  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-surface p-4">
      ...
      <div className="mb-8 flex flex-col items-center gap-3">
        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-500 shadow-card-md">
        ...
        <div className="text-center">
          <h1 className="text-xl font-bold text-slate-100">ISP Billing</h1>
          <p className="text-sm text-slate-400">Customer &amp; payment management</p>
        </div>
      </div>
      ...
      <div className="w-full max-w-sm">
        <div className="card shadow-card-md">
          ...
          <form action={action} className="space-y-4" noValidate>
            ...
            {state?.error && (
              <div role="alert" className="flex items-center gap-2 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2.5 text-sm text-red-300">
