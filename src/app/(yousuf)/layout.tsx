      ...
      <aside className="hidden w-64 flex-shrink-0 flex-col border-r border-surface-border bg-surface-card lg:flex">
        ...
        <div className="border-b border-white/5 px-5 py-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-sm font-bold text-slate-100 leading-tight">ISP Billing</div>
              <div className="text-xs text-slate-400 leading-tight mt-0.5">{session.name}</div>
            </div>
          </div>
        </div>
